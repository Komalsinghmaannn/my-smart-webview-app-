...
import com.sempal.myapplication.DB.FavoritesOperations;
import com.sempal.myapplication.Fragments.AllSongFragment;
import com.sempal.myapplication.Fragments.CurrentSongFragment;
import com.sempal.myapplication.Fragments.FavSongFragment;
import com.sempal.myapplication.Model.SongsList;

import java.util.ArrayList;


public class audioplayer extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    private void grantedPermission() {
        if (ContextCompat.checkSelfPermission(audioplayer.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(audioplayer.this,
                    new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSION_REQUEST);
            if (ActivityCompat.shouldShowRequestPermissionRationale(audioplayer.this,
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (playContinueFlag) {
                    if (currentPosition + 1 < songList.size()) {
                        ...
                        Toast.makeText(audioplayer.this, "PlayList Ended", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
