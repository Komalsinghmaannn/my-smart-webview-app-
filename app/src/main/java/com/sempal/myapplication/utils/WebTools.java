package com.sempal.myapplication.utils;
...
import com.sempal.myapplication.App;
import com.sempal.myapplication.R;
import com.sempal.myapplication.browser2;
...
public class WebTools {
  ...
  /*  public static void share(Context context, String extraText) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, context.getString(R.string.shhare));
...
//                        || backUrl.startsWith("alipays:")//支付宝
    ...
    public static void share(browser2 browser2, String shareText) {
